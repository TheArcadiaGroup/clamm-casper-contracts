...
use casper_types::{CLTyped, ContractVersion};
...
pub fn encode_key(bs: &[u8]) -> String {
    let bytes = runtime::blake2b(bs);
    hex::encode(bytes)
}
...
pub fn encode_2<T1: CLTyped + ToBytes, T2: CLTyped + ToBytes>(t1: &T1, t2: &T2) -> Vec<u8> {
    let mut bytes_1 = t1.to_bytes().unwrap_or_default();
    let mut bytes_2 = t2.to_bytes().unwrap_or_default();
...
pub fn encode_3<T1: CLTyped + ToBytes, T2: CLTyped + ToBytes, T3: CLTyped + ToBytes>(
    ...
    let mut bytes_1 = t1.to_bytes().unwrap_or_default();
    let mut bytes_2 = t2.to_bytes().unwrap_or_default();
    let mut bytes_3 = t3.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
...
>(
    ...
    let mut bytes_2 = t2.to_bytes().unwrap_or_default();
    let mut bytes_3 = t3.to_bytes().unwrap_or_default();
    let mut bytes_4 = t4.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
...
>(
    ...
    let mut bytes_3 = t3.to_bytes().unwrap_or_default();
    let mut bytes_4 = t4.to_bytes().unwrap_or_default();
    let mut bytes_5 = t5.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
    bytes_1.append(&mut bytes_4);
...
>(
    ...
    let mut bytes_4 = t4.to_bytes().unwrap_or_default();
    let mut bytes_5 = t5.to_bytes().unwrap_or_default();
    let mut bytes_6 = t6.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
    bytes_1.append(&mut bytes_4);
    bytes_1.append(&mut bytes_5);
    bytes_1.append(&mut bytes_6);
    bytes_1
}
...
>(
    ...
    let (t3, remainder) = T3::from_bytes(remainder).unwrap();
    let (t4, remainder) = T4::from_bytes(remainder).unwrap();
    let (t5, remainder) = T5::from_bytes(remainder).unwrap();
    let (t6, _) = T6::from_bytes(remainder).unwrap();
    (t1, t2, t3, t4, t5, t6)
}
...
>(
    ...
    let mut bytes_5 = t5.to_bytes().unwrap_or_default();
    let mut bytes_6 = t6.to_bytes().unwrap_or_default();
    let mut bytes_7 = t7.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
    bytes_1.append(&mut bytes_4);
    bytes_1.append(&mut bytes_5);
    bytes_1.append(&mut bytes_6);
    bytes_1.append(&mut bytes_7);
    bytes_1
}
...
>(
    ...
    let (t4, remainder) = T4::from_bytes(remainder).unwrap();
    let (t5, remainder) = T5::from_bytes(remainder).unwrap();
    let (t6, remainder) = T6::from_bytes(remainder).unwrap();
    let (t7, _) = T7::from_bytes(remainder).unwrap();
    (t1, t2, t3, t4, t5, t6, t7)
}
...
>(
    ...
    let mut bytes_6 = t6.to_bytes().unwrap_or_default();
    let mut bytes_7 = t7.to_bytes().unwrap_or_default();
    let mut bytes_8 = t8.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
    bytes_1.append(&mut bytes_4);
    bytes_1.append(&mut bytes_5);
...
>(
    ...
    let (t5, remainder) = T5::from_bytes(remainder).unwrap();
    let (t6, remainder) = T6::from_bytes(remainder).unwrap();
    let (t7, remainder) = T7::from_bytes(remainder).unwrap();
    let (t8, _) = T8::from_bytes(remainder).unwrap();
    (t1, t2, t3, t4, t5, t6, t7, t8)
}
...
>(
    ...
    let mut bytes_7 = t7.to_bytes().unwrap_or_default();
    let mut bytes_8 = t8.to_bytes().unwrap_or_default();
    let mut bytes_9 = t9.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
    bytes_1.append(&mut bytes_4);
    bytes_1.append(&mut bytes_5);
...
>(
    ...
    let (t6, remainder) = T6::from_bytes(remainder).unwrap();
    let (t7, remainder) = T7::from_bytes(remainder).unwrap();
    let (t8, remainder) = T8::from_bytes(remainder).unwrap();
    let (t9, _) = T9::from_bytes(remainder).unwrap();
    (t1, t2, t3, t4, t5, t6, t7, t8, t9)
}
...
>(
    ...
    let mut bytes_8 = t8.to_bytes().unwrap_or_default();
    let mut bytes_9 = t9.to_bytes().unwrap_or_default();
    let mut bytes_10 = t10.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
    bytes_1.append(&mut bytes_4);
    bytes_1.append(&mut bytes_5);
...
>(
    ...
    let mut bytes_9 = t9.to_bytes().unwrap_or_default();
    let mut bytes_10 = t10.to_bytes().unwrap_or_default();
    let mut bytes_11 = t11.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
    bytes_1.append(&mut bytes_4);
    bytes_1.append(&mut bytes_5);
...
>(
    ...
    let mut bytes_10 = t10.to_bytes().unwrap_or_default();
    let mut bytes_11 = t11.to_bytes().unwrap_or_default();
    let mut bytes_12 = t12.to_bytes().unwrap_or_default();
    bytes_1.append(&mut bytes_2);
    bytes_1.append(&mut bytes_3);
    bytes_1.append(&mut bytes_4);
    bytes_1.append(&mut bytes_5);
...
>(
    ...
    let (t7, remainder) = T7::from_bytes(remainder).unwrap();
    let (t8, remainder) = T8::from_bytes(remainder).unwrap();
    let (t9, remainder) = T9::from_bytes(remainder).unwrap();
    let (t10, _) = T10::from_bytes(remainder).unwrap();
    (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10)
}
...
>(
    ...
    let (t8, remainder) = T8::from_bytes(remainder).unwrap();
    let (t9, remainder) = T9::from_bytes(remainder).unwrap();
    let (t10, remainder) = T10::from_bytes(remainder).unwrap();
    let (t11, _) = T11::from_bytes(remainder).unwrap();
    (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11)
}
...
>(
    ...
    let (t9, remainder) = T9::from_bytes(remainder).unwrap();
    let (t10, remainder) = T10::from_bytes(remainder).unwrap();
    let (t11, remainder) = T11::from_bytes(remainder).unwrap();
    let (t12, _) = T12::from_bytes(remainder).unwrap();
    (t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12)
}
...
pub fn call_versioned_contract_with_return_any(
    ...
    let (contract_package_hash_ptr, contract_package_hash_size, _bytes) =
        _to_ptr(contract_package_hash);
    let (contract_version_ptr, contract_version_size, _bytes) = _to_ptr(contract_version);
    let (entry_point_name_ptr, entry_point_name_size, _bytes) = _to_ptr(entry_point_name);
    let (runtime_args_ptr, runtime_args_size, _bytes) = _to_ptr(runtime_args);
    let bytes_written = {
        let mut bytes_written = MaybeUninit::uninit();
        let ret = unsafe {
...
fn deserialize_contract_result(bytes_written: usize) -> Vec<u8> {
    if bytes_written == 0 {
        ...
        _read_host_buffer_into(&mut dest).unwrap_or_revert();
        dest
    }
}